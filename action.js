...
function action(option, callback) {
  ...
  if (typeof option.xim_content === 'undefined' || typeof option.xim_content.hue_access_token === 'undefined' || typeof option.xim_content.bridgeid === 'undefined') {
    ...
    } else if (option.light_action.toggle) {
      if (typeof option.light_action.toggle !== 'undefined') {
    ...
    // color
    if (option.light_action.hue &&
        option.light_action.brightness &&
        option.light_action.saturation) {
